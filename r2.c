...
void frontscreen(void)
{
     ...
     glClearColor(1.0,1.0,0.2,0.0);
     int s;
     glClear(GL_COLOR_BUFFER_BIT);

     glRasterPos2i(-200,380);                                                    //displays college name
     ...
     glRasterPos2i(-250,280);                                                     //displays dept.                 
     for(s=0;dept[s]!='\0';s++)        
     {
     ...
     glRasterPos2i(-100,220);                                                    //displays project name                          
     for(s=0;title[s]!='\0';s++)
     {
     ...
     glRasterPos2i(-580,190);                                                    //displays dashes1                                    
     for(s=0;dash[s]!='\0';s++)
     {
     glColor3f(0.0,0.0,0.0);            
     ...
     glRasterPos2i(-550,150);                                                    //displays heading of table                   
     ...
     glRasterPos2i(-580,110);                                                    //displays dashes2            
     for(s=0;dash[s]!='\0';s++)                       
     {
     glColor3f(0.0,0.0,0.0);            
     glutBitmapCharacter(GLUT_BITMAP_9_BY_15,dash[s]);
     ...
     glRasterPos2i(-550,70);                                                    //displays 1st row in table                
     for(s=0;row1[s]!='\0';s++)
     {
     glColor3f(0.0,0.0,0.0);            
     ...
     glRasterPos2i(-550,20);                                                    //displays 2nd row in table                        
     for(s=0;row2[s]!='\0';s++)
     {
     glColor3f(0.0,0.0,0.0);            
     ...
     glRasterPos2i(-580,-10);                                                    //displays dashes3    
     for(s=0;dash[s]!='\0';s++)
     {
     glColor3f(0.0,0.0,0.0);            
     glutBitmapCharacter(GLUT_BITMAP_9_BY_15,dash[s]);
     ...
     glRasterPos2i(0,-200);                                                    //displays "enter msg"     
     for(s=0;emsg[s]!='\0';s++)
     {
...
void endscreen(void)
{
	glPushMatrix();
     ...
     glRasterPos2i(-700,380);                                                    //displays end message
     for(s=0;str9[s]!='\0';s++)
     {
     glColor3f(0.7,0.0,0.0);            
     glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,str9[s]);
 }
glRasterPos2i(-700,340);                                                    //displays end message
     for(s=0;str10[s]!='\0';s++)
     {
     glColor3f(0.7,0.0,0.0);            
     glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,str10[s]);
 }
glRasterPos2i(-700,300);                                                    //displays end message
     for(s=0;str11[s]!='\0';s++)
     {
     glColor3f(0.7,0.0,0.0);            
     glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,str11[s]);
 }
	glPopMatrix();
}
...
points rainpoint21[]={{-555.0,480.0},{-555.0,460.0},{-555.0,440.0},{-555.0,420.0},{-555.0,400.0},{-555.0,380.0},{-555.0,360.0},{-555.0,340.0},{-555.0,320.0},{-555.0,300.0},{-555.0,280.0}};
points rainpoint23[]={{-515.0,480.0},{-515.0,460.0},{-515.0,440.0},{-515.0,420.0},{-515.0,400.0},{-515.0,380.0},{-515.0,360.0},{-515.0,340.0},{-515.0,320.0},{-515.0,300.0},{-515.0,280.0}};
points rainpoint25[]={{-475.0,480.0},{-475.0,460.0},{-475.0,440.0},{-475.0,420.0},{-475.0,400.0},{-475.0,380.0},{-475.0,360.0},{-475.0,340.0},{-475.0,320.0},{-475.0,300.0},{-475.0,280.0}};
points rainpoint27[]={{-435.0,480.0},{-435.0,460.0},{-435.0,440.0},{-435.0,420.0},{-435.0,400.0},{-435.0,380.0},{-435.0,360.0},{-435.0,340.0},{-435.0,320.0},{-435.0,300.0},{-435.0,280.0}};
points rainpoint29[]={{-695.0,480.0},{-695.0,460.0},{-695.0,440.0},{-695.0,420.0},{-695.0,400.0},{-695.0,380.0},{-695.0,360.0},{-695.0,340.0},{-695.0,320.0},{-695.0,300.0},{-695.0,280.0},{-695.0,260.0},{-695.0,240.0},{-695.0,220.0},{-695.0,200.0},{-695.0,180.0}};

points rainpoint31[]={{-7555.0,480.0},{-655.0,460.0},{-655.0,440.0},{-655.0,420.0},{-655.0,400.0},{-655.0,380.0},{-655.0,360.0},{-655.0,340.0},{-655.0,320.0},{-655.0,300.0},{-655.0,280.0},{-655.0,260.0},{-655.0,240.0},{-655.0,220.0},{-655.0,200.0}};
points rainpoint33[]={{-615.0,480.0},{-615.0,460.0},{-615.0,440.0},{-615.0,420.0},{-615.0,400.0},{-615.0,380.0},{-615.0,360.0},{-615.0,340.0},{-615.0,320.0},{-615.0,300.0},{-615.0,280.0},{-615.0,260.0},{-615.0,240.0}};
points rainpoint35[]={{-575.0,480.0},{-575.0,460.0},{-575.0,440.0},{-575.0,420.0},{-575.0,400.0},{-575.0,380.0},{-575.0,360.0},{-575.0,340.0},{-575.0,320.0},{-575.0,300.0},{-575.0,280.0},{-575.0,260.0}};
...
/*void rain87()
{
	...
	for( k=24;k>=0;k--)
	{
		if(rainpoint87[k][1]==340.0)
		{
			rainpoint87[k][1]=480.0;
		}
	}
...
unsigned char *data=stbi_load("hydrocell.jpg",&width,&height,&nrc,0);
